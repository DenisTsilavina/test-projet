...
@section('content')
    ...
    <div class="grid-2">
        <div class="card lg:px-8">
            ...
            <table class="table table-striped table-hover mb-0">
                ...
                @forelse($venteRecentes as $vente)
                    <tr>
                        <td style="color:var(--text-muted);">#V-{{ str_pad($vente->id, 4, '0', STR_PAD_LEFT) }}</td>
        ...
        <div class="card gray">
            ...
            <p style="font-size:13px;margin-bottom:1rem;">Enregistrez une vente directement depuis cette page.</p>
            <a href="{{ route('admin.vente.create') }}" class="btn btn-primary" style="display:block;text-align:center;margin-bottom:10px;">
                + Nouvelle vente
            </a>
            <a class="btn btn-danger" href="{{ route('admin.vente.index') }}" style="display:block;text-align:center;">
                Voir l'historique
            </a>
        </div>
    </div>
