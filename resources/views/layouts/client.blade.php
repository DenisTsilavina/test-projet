            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-6">
                    <div class="hidden sm:-my-px sm:flex sm:space-x-6">
                        ...
                        {{-- LIEN ACCUEIL (Espace Client) --}}
                        <a href="{{ route('client.dashboard') }}"
                           class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition focus:outline-none
                            {{ request()->routeIs('client.dashboard') ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                            <i class="fa-solid fa-house mr-2 {{ request()->routeIs('client.dashboard') ? 'text-indigo-500' : 'text-gray-400' }}"></i>
                            Accueil
                        </a>
                        ...
                        <a href="{{ route('commande.create') }}"
                           class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition focus:outline-none
                             {{ request()->routeIs('commande.create') ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}"><i class="fa-solid fa-box mr-2 {{ request()->routeIs('commande.create') ? 'text-indigo-500' : 'text-gray-400' }}"></i>
                            Commandes
                        </a>
